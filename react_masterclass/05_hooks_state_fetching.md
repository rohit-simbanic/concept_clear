...
### ২. কেন এই কনসেপ্টটি তৈরি হয়েছে (Why this concept exists)
React-এর রেন্ডারিং লাইফসাইকেল অত্যন্ত কঠোর। রেন্ডার ফাংশনের ভেতরে সরাসরি কোনো সাইড ইফেক্ট (যেমন API কল) চালানো যাবে না, কারণ এটি ব্রাউজার স্ক্রিন লক করে ফেলতে পারে অথবা ইনফিনিট লুপের সৃষ্টি করতে পারে। রেন্ডার কমপ্লিট হওয়ার পর ব্যাকগ্রাউন্ডে সাইড ইফেক্টগুলো চালানোর জন্য একটি সুনির্দিষ্ট উপায় দরকার ছিল, আর এটি করার জন্যই `useEffect` আনা হয়েছে।
