...
* **Dependency Array `[]` খালি থাকলে:** ইফেক্টটি শুধু প্রথম রেন্ডারের পর (Mounting) একবার রান করে।
...
* **Cleanup Function:** ইফেক্ট ফাংশন যদি কোনো ফাংশন রিটার্ন করে, তবে পরবর্তী ইফেক্ট রান করার আগে অথবা কম্পোনেন্ট আনমাউন্ট হওয়ার সময় React সেই ক্লিনআপ ফাংশনটি রান করে মেমরি লিক পরিষ্কার করে।
